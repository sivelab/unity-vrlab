...
namespace Tobii.XR
{
    public class OpenVRControllerAdapter : IControllerAdapter
    {
        ...
        {
            var durationEquivalent = (ushort) (Mathf.Clamp01(hapticStrength) * ushort.MaxValue);
            var system = Valve.VR.OpenVR.System;
            if (system != null)
            {
                system.TriggerHapticPulse(_controllerIndex, VibrationAxisId, durationEquivalent);
            }
        }
